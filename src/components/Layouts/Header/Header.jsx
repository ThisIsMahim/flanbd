...
const Header = () => {
  ...
  return (
    <>
      <header className={`header-wrapper ${isScrolled ? 'scrolled' : ''} ${isHomePage ? 'home-page' : ''}`}>
        <AnimatePresence>
        ...
        <div className="header-inner-box">
          <div className="header-container">
            ...
            <Link to="/" className="header-logo">
              <img src="/logo.png" className="logo-img" alt="Flan Logo" />
            </Link>
            ...
            <div className="header-actions">
                ...
                <AnimatePresence>
                  {accountDropdownOpen && (
                    <motion.div 
                      ...
                      transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }} // ease-out-expo style
                    >
                      {isAuthenticated ? (
                        <>
              ...
              <Link to="/wishlist" className="header-icon-btn wishlist-icon-desktop relative" aria-label="Wishlist">
                ...
                {wishlistItems?.length > 0 && <span className="cart-badge badge-red">{wishlistItems.length}</span>}
              </Link>
          ...
          {/* Search Bar Row — Hidden on home page by default */}
          {!isHomePage && (
