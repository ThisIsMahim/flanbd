...
export const userReducer = (state = { 
    ...
    switch (type) {
        ...
        case CHECK_GOLD_STATUS_REQUEST:
        case UPDATE_TOTAL_SPENT_REQUEST:
            return {
                ...state,
                loading: true,
            };
        case CHECK_GOLD_STATUS_SUCCESS:
        case UPDATE_TOTAL_SPENT_SUCCESS:
            return {
                ...state,
                loading: false,
                user: payload,
        ...
        case CHECK_GOLD_STATUS_FAIL:
        case UPDATE_TOTAL_SPENT_FAIL:
            return {
                ...state,
                loading: false,
                error: payload,
