import { NEW_ORDER_REQUEST, NEW_ORDER_SUCCESS, NEW_ORDER_FAIL, CLEAR_ERRORS, MY_ORDERS_FAIL, MY_ORDERS_SUCCESS, MY_ORDERS_REQUEST, MY_ORDERS_SUMMARY_REQUEST, MY_ORDERS_SUMMARY_SUCCESS, MY_ORDERS_SUMMARY_FAIL, PAYMENT_STATUS_REQUEST, PAYMENT_STATUS_SUCCESS, PAYMENT_STATUS_FAIL, ORDER_DETAILS_REQUEST, ORDER_DETAILS_SUCCESS, ORDER_DETAILS_FAIL, ALL_ORDERS_REQUEST, ALL_ORDERS_SUCCESS, ALL_ORDERS_FAIL, UPDATE_ORDER_REQUEST, DELETE_ORDER_REQUEST, UPDATE_ORDER_SUCCESS, DELETE_ORDER_SUCCESS, UPDATE_ORDER_FAIL, DELETE_ORDER_FAIL, UPDATE_ORDER_RESET, DELETE_ORDER_RESET } from "../constants/orderConstants";
...
export const myOrdersSummaryReducer = (state = { summary: null }, { type, payload }) => {
    switch (type) {
        case MY_ORDERS_SUMMARY_REQUEST:
            return { loading: true };
        case MY_ORDERS_SUMMARY_SUCCESS:
            return { loading: false, summary: payload };
        case MY_ORDERS_SUMMARY_FAIL:
