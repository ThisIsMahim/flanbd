  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "searchbar-bg": "var(--searchbar-bg)",
        "searchbar-focus-bg": "var(--searchbar-focus-bg)",
    ...
    colors: {
      ...
      gray: colors.gray,
      red: colors.red,
      // Override yellow to Flan brand red scale
      yellow: {
        50: 'rgb(253, 251, 220)',
        100: 'rgb(252, 249, 186)',
        200: 'rgb(251, 246, 152)',
  ...
  plugins: [
    function ({ addUtilities, theme, e }) {
      ...
      colorVars.forEach((name) => {
        newUtilities[`.text-${e(name)}`] = { color: `var(--${name})` };
        newUtilities[`.bg-${e(name)}`] = { backgroundColor: `var(--${name})` };
        newUtilities[`.border-${e(name)}`] = { borderColor: `var(--${name})` };
      });
